...
exports.main = function() {
  ...
  if (!require("simple-storage").storage.filteredSites)
    require("simple-storage").storage.filteredSites =
...
function activatePageMod() {
  ...
  pageMod = require("page-mod").PageMod({
    ...
    include: require("simple-storage").storage.filteredSites,
...
function storeConfig(data) {
  ...
  require("simple-storage").storage.filteredSites = data;
